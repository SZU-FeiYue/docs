...
<h1>飞跃手册</h1>
<p class="home-lead">本校学生出国（境）升学、推免、考研与就业的经验汇编。现公开 61 篇，2021–2026 届。</p>
</div>
...
截至目前，手册公开案例 **61** 篇，覆盖 2021–2026 届。按路径分布如下。
...
计算机相关专业占比较高，反映既有来稿结构，并不表示手册仅面向该学院。其他学院来稿同等收录。
...
2. **结果**：投递清单及录取、拒信、候补等结果，含未成功路径。
3. **过程**：信息来源、关键时间节点，以及事后仍认为有效的判断。

栏目内按毕业届编排，新近届次列于前。常用简称见 [术语表](#appendix)。
...
| bg | 背景（background） |
| tl | timeline |
| HYPSM / 哈耶普斯麻 | 哈佛、耶鲁、普林斯顿、斯坦福、麻省理工 |
| bar | 门槛 |
...
其他学校和社区的申请经验，按需参考。部分站点可能需要登录，或已不再更新。
...
内容由编写委员会收集、整理并发布，仅供参考，不代表任何机构或政治立场。全部内容依据 [CC BY-NC 4.0](https://creativecommons.org/licenses/by-nc/4.0/) 授权，不得用于商业用途；转载或引用须注明来源。

不遵守本声明或违法使用手册内容的，依法保留追究权利。
